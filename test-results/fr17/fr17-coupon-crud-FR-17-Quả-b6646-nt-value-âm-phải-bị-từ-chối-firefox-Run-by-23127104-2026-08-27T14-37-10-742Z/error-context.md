...
- Name: fr17-coupon-crud.spec.ts >> FR-17: Quản lý Mã Giảm Giá (Coupon CRUD) | Run by: 23127104 >> TC11 - [RULE-13/spec] discount_value âm phải bị từ chối
...
Locator:  getByRole('row').filter({ hasText: 'FR17NEGDISC' })
Expected: 0
Received: 1
Timeout:  10000ms
...
Call log:
  ...
  - waiting for getByRole('row').filter({ hasText: 'FR17NEGDISC' })
...
- generic [ref=e3]:
  ...
  - generic [ref=e15]:
    ...
    - generic [ref=e17]:
      ...
      - generic [ref=e19]:
        - 'textbox "Mã coupon (VD: SAVE10)" [ref=e20]': FR17NEGDISC
        - combobox [ref=e21]:
    ...
    - table [ref=e27]:
      ...
      - rowgroup [ref=e37]:
        ...
        - row [ref=e83]:
          - cell "FR17PAST" [ref=e84]
          - cell "Phần trăm" [ref=e85]
          - cell "10%" [ref=e86]
          - cell "0 ₫" [ref=e87]
          - cell "Hết hạn" [ref=e88]
          - cell "1 lần" [ref=e89]
          - cell [ref=e90]:
