...
- Name: fr17-coupon-crud.spec.ts >> FR-17: Quản lý Mã Giảm Giá (Coupon CRUD) | Run by: 23127104 >> TC05 - [RULE-04/Error] Bỏ trống code
...
Locator:  getByRole('textbox', { name: 'Mã coupon (VD: SAVE10)' })
...
Call log:
  ...
  - waiting for getByRole('textbox', { name: 'Mã coupon (VD: SAVE10)' })
    23 × locator resolved to <input value="" required="" class="border p-2 rounded" placeholder="Mã coupon (VD: SAVE10)"/>
       - unexpected value "Fill out this field"
