...
- Name: fr11-order-history.spec.ts >> FR-11: Xem lịch sử đơn hàng (User) | Run by: 23127104 >> TC08 - [RULE-07] User không thể thao tác với đơn delivered
...
```ts
  ...
  2   | import testData from '../data/fr11-testcases-draft.json';
  3   | 
