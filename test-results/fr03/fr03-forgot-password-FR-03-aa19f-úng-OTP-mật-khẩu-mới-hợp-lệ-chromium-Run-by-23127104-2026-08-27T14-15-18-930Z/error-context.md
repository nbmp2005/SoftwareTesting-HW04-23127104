...
+
+     EShopGiỏ hàngĐăng nhậpĐăng kýQuên Mật KhẩuMã OTP của bạn là: 3272Mã OTP (4 số)Mật khẩu mớiĐặt lại mật khẩu← Quay lại© 2026 EShop SUT. Dành cho mục đích kiểm thử.
+     
+   
+
+
...
- main:
  ...
  - text: "Mã OTP của bạn là: 3272 Mã OTP (4 số)"
  - textbox: "3272"
  - text: Mật khẩu mới
  - textbox: Abc@12345
