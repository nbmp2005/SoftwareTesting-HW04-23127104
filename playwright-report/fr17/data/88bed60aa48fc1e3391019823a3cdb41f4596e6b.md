...
- Name: fr17-coupon-crud.spec.ts >> FR-17: Quản lý Mã Giảm Giá (Coupon CRUD) | Run by: 23127104 >> TC12 - [RULE-14/spec] min_order_amount âm phải bị từ chối
...
Locator:  getByRole('row').filter({ hasText: 'FR17NEGMIN' })
Expected: 0
Received: 1
Timeout:  10000ms
...
Call log:
  ...
  - waiting for getByRole('row').filter({ hasText: 'FR17NEGMIN' })
...
- generic [ref=e3]:
  ...
  - generic [ref=e15]:
    ...
    - generic [ref=e17]:
      ...
      - generic [ref=e19]:
        - 'textbox "Mã coupon (VD: SAVE10)" [ref=e20]': FR17NEGMIN
        - combobox [ref=e21]:
          - option "Phần trăm (%)" [selected]
          - option "Số tiền cố định (₫)"
        - 'spinbutton "Giá trị % (VD: 10)" [ref=e22]': "10"
    ...
    - table [ref=e27]:
      ...
      - rowgroup [ref=e37]:
        ...
        - row [ref=e92]:
          - cell "FR17PAST" [ref=e93]
          - cell "Phần trăm" [ref=e94]
          - cell "10%" [ref=e95]
          - cell "0 ₫" [ref=e96]
          - cell "Hết hạn" [ref=e97]
          - cell "1 lần" [ref=e98]
          - cell [ref=e99]:
            - button "Xóa" [ref=e100] [cursor=pointer]
        - row [ref=e101]:
          - cell "SAVE10" [ref=e102]
