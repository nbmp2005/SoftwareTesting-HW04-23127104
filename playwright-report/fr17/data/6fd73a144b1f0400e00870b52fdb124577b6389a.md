...
- Name: fr17-coupon-crud.spec.ts >> FR-17: Quản lý Mã Giảm Giá (Coupon CRUD) | Run by: 23127104 >> TC10 - [RULE-12/spec] discount_value = 0 phải bị từ chối
...
Locator:  getByRole('row').filter({ hasText: 'FR17ZERO' })
Expected: 0
Received: 1
Timeout:  10000ms
...
Call log:
  ...
  - waiting for getByRole('row').filter({ hasText: 'FR17ZERO' })
...
- generic [ref=e3]:
  ...
  - generic [ref=e15]:
    ...
    - generic [ref=e17]:
      ...
      - generic [ref=e19]:
        - 'textbox "Mã coupon (VD: SAVE10)" [ref=e20]': FR17ZERO
        - combobox [ref=e21]:
          - option "Phần trăm (%)" [selected]
          - option "Số tiền cố định (₫)"
        - 'spinbutton "Giá trị % (VD: 10)" [ref=e22]': "0"
