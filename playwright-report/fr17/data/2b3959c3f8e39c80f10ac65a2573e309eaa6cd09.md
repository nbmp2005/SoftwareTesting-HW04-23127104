...
- Name: fr17-coupon-crud.spec.ts >> FR-17: Quản lý Mã Giảm Giá (Coupon CRUD) | Run by: 23127104 >> TC16 - [Mục 6 xác nhận] percent > 100 phải bị từ chối
...
Locator:  getByRole('row').filter({ hasText: 'FR17P101' })
Expected: 0
Received: 1
Timeout:  10000ms
...
Call log:
  ...
  - waiting for getByRole('row').filter({ hasText: 'FR17P101' })
...
- generic [ref=e3]:
  ...
  - generic [ref=e15]:
    ...
    - generic [ref=e17]:
      ...
      - generic [ref=e19]:
        - 'textbox "Mã coupon (VD: SAVE10)" [ref=e20]': FR17P101
        - combobox [ref=e21]:
          - option "Phần trăm (%)" [selected]
          - option "Số tiền cố định (₫)"
        - 'spinbutton "Giá trị % (VD: 10)" [ref=e22]': "101"
    ...
    - table [ref=e27]:
      ...
      - rowgroup [ref=e37]:
        ...
        - row [ref=e74]:
          - cell "FR17PAST" [ref=e75]
          - cell "Phần trăm" [ref=e76]
          - cell "10%" [ref=e77]
          - cell "0 ₫" [ref=e78]
          - cell "Hết hạn" [ref=e79]
          - cell "1 lần" [ref=e80]
          - cell [ref=e81]:
